...
/*
  DeleteProduct Returns a list of products from the data base
*/
...
/*
  ListProducts Returns a list of products from the data base
*/
...
/*
  ListSingleProduct Returns the product with a given id
*/
